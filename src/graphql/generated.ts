...
export type CreateSusbcriberMutationVariables = Exact<{
  name: Scalars['String'];
  email: Scalars['String'];
}>;


export type CreateSusbcriberMutation = { __typename?: 'Mutation', createSubscriber?: { __typename?: 'Subscriber', id: string } | null };
...
export const CreateSusbcriberDocument = gql`
    mutation CreateSusbcriber($name: String!, $email: String!) {
  createSubscriber(data: {name: $name, email: $email}) {
    id
  }
}
    `;
export type CreateSusbcriberMutationFn = Apollo.MutationFunction<CreateSusbcriberMutation, CreateSusbcriberMutationVariables>;

/**
 * __useCreateSusbcriberMutation__
 *
 * To run a mutation, you first call `useCreateSusbcriberMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCreateSusbcriberMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [createSusbcriberMutation, { data, loading, error }] = useCreateSusbcriberMutation({
 *   variables: {
 *      name: // value for 'name'
 ...
 * });
 */
export function useCreateSusbcriberMutation(baseOptions?: Apollo.MutationHookOptions<CreateSusbcriberMutation, CreateSusbcriberMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CreateSusbcriberMutation, CreateSusbcriberMutationVariables>(CreateSusbcriberDocument, options);
      }
export type CreateSusbcriberMutationHookResult = ReturnType<typeof useCreateSusbcriberMutation>;
export type CreateSusbcriberMutationResult = Apollo.MutationResult<CreateSusbcriberMutation>;
export type CreateSusbcriberMutationOptions = Apollo.BaseMutationOptions<CreateSusbcriberMutation, CreateSusbcriberMutationVariables>;
